...
const file_notify_v1_notify_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05errorB\xb3\x01\n" +
	"\rcom.notify.v1B\vNotifyProtoP\x01ZPgithub.com/KasumiMercury/primind-central-backend/internal/gen/notify/v1;notifyv1\xa2\x02\x03NXX\xaa\x02\tNotify.V1\xca\x02\tNotify\\V1\xe2\x02\x15Notify\\V1\\GPBMetadata\xea\x02\n" +
